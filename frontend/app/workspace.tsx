  ...
  return (
    <View style={{ flex: 1, backgroundColor: c.surface, paddingTop: insets.top }}>
      <View style={styles.topBar}>
        <Pressable testID="workspace-back" onPress={() => router.back()} style={styles.iconBtn} hitSlop={8}>
        ...
        <View style={styles.topActions}>
          ...
          >
            <MaterialCommunityIcons
              ...
              size={22}
              color={mode === "trash" ? c.brand : c.onSurface}
            />
          </Pressable>
          <Pressable testID="workspace-new" onPress={newRootPage} style={styles.iconBtn} hitSlop={6}>
...
const styles = StyleSheet.create({
  topBar: { flexDirection: "row", alignItems: "center", height: 56, paddingHorizontal: 8 },
  iconBtn: { width: 40, height: 40, alignItems: "center", justifyContent: "center" },
  heading: { flex: 1, fontSize: 22, fontWeight: "800", letterSpacing: -0.5, marginLeft: 4 },
